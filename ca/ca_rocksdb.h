...
/* ====================================================================================  
 ...
 ==================================================================================== */
   ...
   int GetInitVer(Transaction* txn, std::string & version);
    ...
    // 设置和获取合约
    int SetContractByAddress(Transaction* txn, const std::string & addr, const std::string & contract, const std::string abi);
    int GetContractByAddress(Transaction* txn, const std::string & addr, std::string & contract, std::string& abi);
...
==================================================================================== */
    ...
    const std::string kAddress2Contract = "addr2contract";  
    const std::string kAddress2Abi = "addr2abi";  
/* ====================================================================================  
 # @description: 交易查询相关
==================================================================================== */
