                        ...
                        const std::vector<uint64_t> &vec_sign_sum) 
{
    ...
    {
        ERRORLOG("(Build) GetBlockNumInUnitTime failed !");
        return -2;
    }
...
int AwardAlgorithm::GetAward(const uint64_t blockNum, uint64_t & awardAmount)
{
    ...
    {
        ERRORLOG("(GetAward) GetBlockHashByBlockHeight failed !");
        return -1;
    }
    ...
    {
        ERRORLOG("(GetAward) GetTimeFromBlockHash failed !");
        return -1;
    }
    ...
    if ( 0 != pRocksDb->GetAwardTotal(txn, award) )
    {
        ...
        // ERRORLOG("(GetAward) GetAwardTotal failed !");
        // return -3;
    }
...
int AwardAlgorithm::GetTimeFromBlockHash(const std::string & blockHash, uint64_t & blockTime)
{
    ...
    if (txn == NULL)
    {
        ERRORLOG("(GetTimeFromBlockHash) TransactionInit failed !");
        return -1;
    }
    ...
    {
        ERRORLOG("(GetTimeFromBlockHash) GetBlockByBlockHash failed !");
        return -2;
    }
...
int AwardAlgorithm::GetBlockNumInUnitTime(uint64_t & blockSum)
{
    ...
    if (txn == NULL)
    {
        ERRORLOG("(GetBlockNumInUnitTime) TransactionInit failed !");
        return -1;
    }
    ...
    {
        ERRORLOG("(GetBlockNumInUnitTime) GetBlockHashsByBlockHeight failed !");
        return -3;
    }
    ...
    for (auto & blockHash : blockHashs)
    {
        ...
        {
            ERRORLOG("(GetBlockNumInUnitTime) GetTimeFromBlock failed !");
            return -4;
        }
...
int AwardAlgorithm::GetSignCountByAddr(const std::string addr, uint64_t & count) 
{
    ...
    if (txn == NULL)
    {
        ERRORLOG("(GetSignCountByAddr) TransactionInit failed !");
        return -1;
    }
    ...
    {
        ERRORLOG("(GetSignCountByAddr) GetAwardCount failed !");
        return -2;
    }
...
int AwardAlgorithm::GetAwardAmountByAddr(const std::string addr, uint64_t & awardAmount) 
{
    ...
    if (txn == NULL)
    {
        ERRORLOG("(GetAwardAmountByAddr) TransactionInit failed !");
        return -1;
    }
    ...
    {
        ERRORLOG("(GetAwardAmountByAddr) GetAllTransactionByAddreess failed !");
        return -2;
    }
    ...
    for (auto blockHash : blockHashs) 
    {
        ...
        {
            ERRORLOG("(GetAwardAmountByAddr) GetBlockByBlockHash failed !");
            return -3;
        }
