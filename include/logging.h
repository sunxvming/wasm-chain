#ifndef EBPC_COMMON_LOGGING_H_
#define EBPC_COMMON_LOGGING_H_
...
bool LogInit(const std::string &path, const std::string &console_out = "false", const std::string &level = "WARN");
bool LogInit(const std::string &path, bool console_out = false, spdlog::level::level_enum level = spdlog::level::warn);
